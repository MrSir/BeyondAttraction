...
# create dbs #
mysql -uroot -pTest1234 -e "CREATE DATABASE beyond_attraction CHARSET utf8 COLLATE utf8_unicode_ci;"
mysql -uroot -pTest1234 -e "CREATE DATABASE beyond_attraction_test CHARSET utf8 COLLATE utf8_unicode_ci;"

# add permissions to root for tables #
mysql -uroot -pTest1234 -e "GRANT ALL PRIVILEGES ON beyond_attraction.* TO 'root'@'localhost';"
mysql -uroot -pTest1234 -e "GRANT ALL PRIVILEGES ON beyond_attraction_test.* TO 'root'@'localhost';"
...
# site config copy
cp /var/www/BeyondAttraction/site.conf /etc/nginx/sites-enabled/beyondattraction.net.conf
